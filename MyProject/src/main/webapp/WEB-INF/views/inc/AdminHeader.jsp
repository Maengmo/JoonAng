        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <% if (session.getAttribute("adminId") != null) { %>
                    ...
                    <li class="nav-item">
	                    <a class="nav-link nav-link-custom white" href="/project/mypage.do">관리자 정보</a>
	                </li>
                    <li class="nav-item">
	                    <a class="nav-link nav-link-custom white" href="/project/talk.do">회원 정보 관리</a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link nav-link-custom white" href="/project/together.do">게시물 관리</a>
	                </li>
                <% } else { %>
                    <%-- 세션에 adminId가 없을 경우(로그아웃 상태) --%>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom white" href="/project/login.do">관리자</a>
                    </li>
                    <li class="nav-item">
