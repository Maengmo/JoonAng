...
<head>
    ...
    <style>
        ...
        .img-box {
            background-image: url(resources/img/adminLogin2.png);
        ...
        <div class="row d-flex align-content-center vh-100 w-75">
            ...
            <div class="col-sm-12 col-md-12 col-lg-5 p-0 bg-white d-flex align-items-center rounded-end h-75">
                <div class="container-md d-flex flex-column align-items-center">
                    ...
                    <p class="fs-6 text-center">관리자 전용 로그인 페이지입니다.</p>
                    <form method="POST" action="/project/adminLogin.do">
...
function showSweetAlert(title, text, icon) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // 페이지 이동 처리
            window.location.href = "/project/admin.do";
        } else {
